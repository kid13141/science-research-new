...
from modules import Hilp2_Embedding
...
class Diff_Hilp4_MAC:
    def __init__(self, scheme, groups, args):
        ...
        self.gating_delta = getattr(args, "gating_delta", 0.3)
    ...
    #     avail_actions = ep_batch["avail_actions"][:, t]
    #     agent_outs, agent_outs_nav, self.hidden_states_1, self.hidden_states_2 = self.agent(agent_inputs, self.hidden_states_1, self.hidden_states_2)
    ...
    #     return agent_outs.view(ep_batch.batch_size, self.n_agents, -1), agent_outs_nav.view(ep_batch.batch_size, self.n_agents, -1),self.hidden_states_1.view(ep_batch.batch_size, self.n_agents, -1), self.hidden_states_2.view(ep_batch.batch_size, self.n_agents, -1)
