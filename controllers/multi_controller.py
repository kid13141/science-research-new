...
class MultiMAC:
    def __init__(self, scheme, groups,args):
        ...
        self.temporal_net = TemporalUnet(
            horizon=args.horizon,
            transition_dim=args.state_shape,
            cond_dim=args.state_shape,
            dim_mults=(1, 4, 8),
        ...
        self.diffusion_agent = GaussianInvDynDiffusion(model=self.temporal_net, horizon=args.horizon, observation_dim=args.state_shape).cuda()
